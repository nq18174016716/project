...
<head>
    ...
    <script type="text/javascript" src="../admin_style/js/jquery.min.js"></script>
    <script type="text/javascript" src="../admin_style/js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="../admin_style/js/bootstrap.min.js"></script>
