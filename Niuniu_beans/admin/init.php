<?php
    ...
    $smarty->setCompileDir(ROOT.'/../templates_c/admin');
    $smarty->setCacheDir(ROOT.'/../smarty_cache/admin');

    $smarty->setCaching(false);//是否使用缓存，项目在调试期间，不建议启用缓存
//    $smarty->caching = false;
    $smarty->setCacheLifetime('60*60*5');// 设置缓存时间
...
//    $smarty->right_delimiter = "}>";
    ...
    require_once (ROOT.'/../include/IMG.class.php');
