...
<header class="navbar navbar-fixed-top" style="background-image: none; background-color: rgb(240, 240, 240);">
    <div class="pull-left">
        <a class="navbar-brand" href="#">
            ...
            <h1 style="font-size: 16px;">金陵贸易</h1>
        </a>
    </div>
            ...
            <ul class="nav sidebar-nav">
                ...
                <li> <a href="#sideEight" class="accordion-toggle"><span class="glyphicons glyphicon-list"></span><span class="sidebar-title">文章管理</span><span class="caret"></span></a>
                    <ul class="nav sub-nav" id="sideEight" style="">
                        <li><a href="knowledge_list.php"><span class="glyphicons glyphicon-record"></span>行业知识</a></li>
                        <li><a href="news_list.php"><span class="glyphicons glyphicon-record"></span> 最新新闻</a></li>
                    </ul>
                </li>
                <li>
                    <a href="pro_list.php"><span class="glyphicons glyphicon-heart-empty"></span><span class="sidebar-title">产品信息</span></a>
                </li>
                <li>
                    <a href="user_list.php"><span class="glyphicons glyphicon-plane"></span><span class="sidebar-title">系统管理员</span></a>
                </li>
            </ul>
        </div>
    </aside>
